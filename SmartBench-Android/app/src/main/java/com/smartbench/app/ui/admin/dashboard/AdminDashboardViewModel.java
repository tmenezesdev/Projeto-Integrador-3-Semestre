...
public class AdminDashboardViewModel extends AndroidViewModel {
    ...
    public final MutableLiveData<Resource<List<Transacao>>> atividadeRecente = new MutableLiveData<>();
    ...
    public void carregarTudo(int diasFluxo) {
        repository.getDashboard(dashboard);
        repository.getFluxo(diasFluxo, fluxo);
        repository.getHistorico(atividadeRecente);
    }
