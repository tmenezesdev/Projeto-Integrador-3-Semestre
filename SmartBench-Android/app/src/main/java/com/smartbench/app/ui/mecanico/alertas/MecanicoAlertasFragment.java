...
public class MecanicoAlertasFragment extends Fragment {

    private FragmentListSearchBinding binding;
    private MecanicoAlertasViewModel viewModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(MecanicoAlertasViewModel.class);

        binding.tvTitle.setText("Meus Alertas");
        binding.btnAction.setVisibility(View.GONE);
        binding.layoutPaginacao.setVisibility(View.GONE);

        // Mecânico não pode resolver alertas
        adapter = new AlertasAdapter(a -> {}, false);
