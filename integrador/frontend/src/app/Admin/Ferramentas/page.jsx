                ...
                <tr key={f.id} className="border-b border-[#7033ff]/5 hover:bg-[#7033ff]/5 transition-colors">
                  ...
                  <td className="px-5 py-3">
                    <div className="flex gap-2">
                      <button onClick={() => openEditar(f)} className="p-1.5 rounded-lg text-slate-500 hover:text-[#7033ff] hover:bg-[#7033ff]/10 transition-colors"><Pencil size={15} /></button>
                      <button onClick={() => { setFormErro(''); setModalDeletar(f); }} className="p-1.5 rounded-lg text-slate-500 hover:text-red-400 hover:bg-red-500/10 transition-colors"><Trash2 size={15} /></button>
                    </div>
                  </td>
                </tr>
              ))}
