    ...
    <div className="p-8 font-sans min-h-full">
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-5 mb-6">
        {Array(4).fill(0).map((_, i) => (
          <div key={i} className="bg-[#0f1a35] border border-teal-500/10 rounded-xl p-5 flex flex-col gap-3">
            <div className="flex items-center justify-between">
              ...
              return (
                <div key={`${f.id}-${f.responsavel}-${idx}`} className="px-6 py-3.5 flex items-center justify-between hover:bg-teal-500/5 transition-colors">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${atrasada ? 'bg-red-500/10 text-red-400 border-red-500/20' : 'bg-teal-500/10 text-teal-400 border-teal-500/20'}`}>
